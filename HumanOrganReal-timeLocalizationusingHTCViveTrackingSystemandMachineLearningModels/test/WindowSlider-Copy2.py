...
import timeimport copy as cp############import data RotationX
...
print(t)#############combine timestamp with RotationX dataframe
...
dataset.head(15)############split dataset into training and testing sets
...
print('RMSE = %.2f' % gbr_rmse)####### WindowSlider help function
ridge_rmse={}
ridge_rmse_list=[]
...
print(ridge_rmse_list)       x_ridge=range(100,4112,100)
...
print(gbr_rmse_list)  x_gbr=range(100,4112,100)
...
plt.show()pip install statsmodels ######autocorrelation 
